...
if __name__ == "__main__":
    ...
    parser.add_argument('--data', type=str, default='round2', help='data path')
    parser.add_argument('--seq_length', type=int, default=5, help='output length')
    parser.add_argument('--in_len', type=int, default=5, help='input length')
    ...
    parser.add_argument('--dims', type=int, default=16, help='dimension of embeddings for dynamic graph')
